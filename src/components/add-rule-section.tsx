...
export const AddRuleSection: React.FC<AddRuleSectionProps> = ({ onAdd }) => {
    ...
    return (
        <div className="echo-gradient-border rounded-lg">
            <div className="echo-gradient-border-inner border border-dashed border-border rounded-lg p-4 bg-card/30">
                <div className="flex items-center gap-2 mb-4">
                    <Plus className="w-5 h-5 text-sky-500" />
                    <span className="font-medium text-[#9B7FE8]">
                        {t('Add a custom rule')}
                    </span>
                </div>
